...
public class MovementHandler : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        // for Raycast to originate from boundary of player's body
        //Vector3 bodyBoundary = this.bodyCollider.bounds.ClosestPoint(this.transform.position + moveDir);
        //Debug.DrawRay(bodyBoundary, moveDir);
